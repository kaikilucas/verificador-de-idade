function cauculadorIdade() {
  ...
  if (sex == "masculino" && idade >= 1 && idade < 13) {
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É uma criança com ${idade} anos de idade.`;
    ...
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É um adolecente com ${idade} anos de idade.`;
    img.style.width = "250px";
    img.style.height = "250px";
    img.style.borderRadius = "50%";
    ...
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É um Homem com ${idade} anos de idade.`;
    img.style.width = "250px";
    img.style.height = "250px";
    img.style.borderRadius = "50%";
    ...
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É um Idoso com ${idade} anos de idade.`;
    img.style.width = "250px";
    img.style.height = "250px";
    img.style.borderRadius = "50%";
    ...
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É uma adolecente com ${idade} anos de idade.`;
    img.style.width = "250px";
    img.style.height = "250px";
    img.style.borderRadius = "50%";
    ...
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É uma Mulher com ${idade} anos de idade.`;
    img.style.width = "250px";
    img.style.height = "250px";
    img.style.borderRadius = "50%";
    ...
    document.getElementById(
      "detectar"
    ).innerHTML = `Detectamos É uma Idosa com ${idade} anos de idade.`;
    img.style.width = "250px";
    img.style.height = "250px";
    img.style.borderRadius = "50%";
    img.src = "img/velha.jpg";
  } else {
    document.getElementById("detectar").innerHTML =
      "Idade não encontrada, favor tentar novamente";
    alert("erro");
  }
}
